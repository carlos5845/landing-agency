      ...
      <header className="relative overflow-hidden pt-20 pb-24 md:pt-32 md:pb-40">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary font-semibold text-sm mb-6 tracking-wide uppercase">
              Identidad del Grupo
            </span>

            <h1 className="text-5xl md:text-7xl font-800 leading-[1.1] mb-8 tracking-tight text-slate-900 dark:text-white">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl">
              NexusData es una agencia consultora multidisciplinaria dedicada a
